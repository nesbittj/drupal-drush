...
mysql_db_url="mysql://root:$mysql_root_pwd@$mysql_container_id/dbname"
...
drush_si_cmd="drush si --site-name=sitename --db-url=$mysql_db_url --db-su=root --db-su-pw=dbname -y"
#eval $drush_si_cmd
